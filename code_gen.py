"""
The code generation step of SmallerC. Recursively parses the tree to generate
asm code.
"""
...
def make_code(root, info, code,
    ...
    if (root.rule == rules.main_func_def_cont or
        ...
        if root.children[1].text == "+":
            ...
            elif type2.pointers == 0 and type2.pointers > 0:
        ...
        info = make_code(root.childrne[1], info, code)
        code.add_command("pop", "rax")
        code.add_command("cmp", "rax", "0")
